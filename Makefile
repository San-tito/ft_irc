...
pkgdatadir = $(datadir)/ngircd
pkgincludedir = $(includedir)/ngircd
pkglibdir = $(libdir)/ngircd
pkglibexecdir = $(libexecdir)/ngircd
...
CFLAGS = -g -O2 -pipe -W -Wall -Wpointer-arith -Wstrict-prototypes -fstack-protector -Wno-format-truncation -DSYSCONFDIR='"$(sysconfdir)"' -DDOCDIR='"$(docdir)"'
CPPFLAGS = 
CSCOPE = cscope
CTAGS = ctags
CYGPATH_W = echo
...
PACKAGE_NAME = ngIRCd
PACKAGE_STRING = ngIRCd 27~6-g512af135
PACKAGE_TARNAME = ngircd
PACKAGE_URL = https://ngircd.barton.de/
PACKAGE_VERSION = 27~6-g512af135
PATH_SEPARATOR = :
